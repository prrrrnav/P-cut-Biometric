...
const FingerprintProductsPage = () => {
  ...
  // ✅ Title comes from navbar click
  const pageTitle = location.state?.pageTitle || "Products";
  ...
  useEffect(() => {
    const loadProducts = async () => {
      try {
        ...
        // backend filter (already supported by you)
        const response = await ApiService.getProducts({
          product_type_id: location.state?.productTypeId || 1
        });
          ...
          >
            ...
            <div className="p-6">
              ...
              <button
                // onClick={() =>
                //   navigate(
                //     `/product/${product.category_id}/${product.product_type_id}/${product.slug || product.id}`,
                //     {
                //       state: {
                //         pageTitle: product.product_type_name
                //       }
                //     }
                //   )
                // }
